	...
	<div class="home-content">
		...
		<div class="row contents">
			<div class="home-content-left">
				<h1 data-aos="fade-up" class="title" align="center">My Profile</h1>
					...
					<tr>
						<td align="center">
							<form method="POST" action="getMyAccountServlet">
								<input type="hidden" name="userID"
									...
									value="Edit Profile"
									style="color: white; background-color: #39b54a; width: 200px; border-style: none; float: right;" />
							</form>
						</td>
						<td align="center" width  = "150">
							<form method="POST" action="RedirectServlet">
								<input type="hidden" name="userID"
									value="${sessionScope.userID }" /> <input type="submit"
									value="Record History" name="button"
									style="color: white; background-color: #39b54a; width: 200px; border-style: none; float: left;" />
							</form>
						</td>
						<td align="center">
							<form method="POST" action="RedirectServlet">
								<input type="hidden" name="userID" value="${sessionScope.userID }" />
								<input type="submit" value="Password Reset" name="button" style="color: white; background-color: #39b54a; width: 200px; border-style: none; float: left;"  />
							</form>
						</td>
