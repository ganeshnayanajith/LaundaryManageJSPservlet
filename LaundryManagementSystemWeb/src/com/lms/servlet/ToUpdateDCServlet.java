...
/**
 * Servlet implementation class ToUpdateDCServlet
 */
@WebServlet("/ToUpdateDCServlet")
public class ToUpdateDCServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ToUpdateDCServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = getServletContext()
				.getRequestDispatcher("/WEB-INF/views/DryCleanUpdateForm.jsp");
