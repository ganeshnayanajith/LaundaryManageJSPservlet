...
/**
 * Servlet implementation class DeleteDCRatesServlet
 */
@WebServlet("/DeleteDCRatesServlet")
public class DeleteDCRatesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteDCRatesServlet() {
        super();
