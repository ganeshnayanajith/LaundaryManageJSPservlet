...
/**
 * Servlet implementation class updateWashFoldStatusServlet
 */
@WebServlet("/updateWashFoldStatusServlet")
public class updateWashFoldStatusServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateWashFoldStatusServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		wfOrder.setOrderStatus(Status);
		
		iOService.updateWashFoldStatus(orderID, wfOrder);
